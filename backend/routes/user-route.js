...
router.post("/users", async (req, res) => {
    let user = await addUser(req.body) // permet d'attendre l'exécution total de la fonction(ajouter dans BD) pour recup les donnée ajouter avant de passer a la  reponse
    res.send(user);
